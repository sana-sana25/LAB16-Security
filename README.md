...
* InsecureShop
<img width="432" height="652" alt="Screenshot 2026-05-22 221005" src="https://github.com/user-attachments/assets/47725454-110a-4ab9-8d00-8d3c3bb71f51" />
...
frida-ps -Uai
```
<img width="1100" height="544" alt="Screenshot 2026-05-22 234903" src="https://github.com/user-attachments/assets/327a152c-8e1c-44ec-b6ed-6eba5c43db8b" />
...
*:8080
```
<img width="1465" height="918" alt="Screenshot 2026-05-22 234641" src="https://github.com/user-attachments/assets/557c19a3-2300-4b2e-8d6c-d56c39763bb3" />
...
Une erreur DNS est apparue au début du laboratoire :
<img width="541" height="758" alt="Screenshot 2026-05-22 233812" src="https://github.com/user-attachments/assets/b84f62d9-e06a-4473-8ab1-68146c0c86fc" />
...
# Vérification du trafic HTTPS

Le navigateur Android a été utilisé pour accéder à :

```text
https://example.com
```
<img width="505" height="439" alt="Screenshot 2026-05-22 234754" src="https://github.com/user-attachments/assets/12eff0a3-9321-467a-82b8-42c1b257c2d4" />
<img width="1908" height="748" alt="image" src="https://github.com/user-attachments/assets/afdd90ec-a62c-48fe-99ee-b728e7a3f8bb" />


Le trafic a été observé dans Burp Suite, confirmant le bon fonctionnement du proxy HTTPS.
...
<img width="768" height="705" alt="Screenshot 2026-05-22 235503" src="https://github.com/user-attachments/assets/edd54ea9-7d08-4a45-bbd0-f96ce7f5b8e0" />
...
```
<img width="1105" height="459" alt="Screenshot 2026-05-22 235258" src="https://github.com/user-attachments/assets/b62a3118-d217-4dc5-820c-7f388b82d9ba" />
...
Après l’injection Frida/Objection :

* le trafic réseau Android apparaissait dans Burp Suite,
* les connexions HTTPS pouvaient être analysées,
* l’interception MITM fonctionnait correctement.

Certaines requêtes système Android ont été observées :

* connectivitycheck.gstatic.com
* play.googleapis.com

L’application InsecureShop utilisée dans ce laboratoire ne générait cependant qu’un trafic réseau limité.
